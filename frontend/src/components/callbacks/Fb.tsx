...
export default function Fb() {
  ...
  async function convertTokenForCode() {
    try {
      const res = await fetch(baseUrl + "/fb/exchangecodefortoken", {
        method: "POST",
  ...
  useEffect(() => {
    if (token) {
      ...
      setError("Missing authentication code from Facebook");
      setLoader(false);
    }
  }, [token]);
      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-xl shadow-lg overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-blue-500 to-blue-600 p-6 text-center">
            <h1 className="text-2xl font-bold text-white">Facebook Connection</h1>
          ...
          <div className="p-8 text-center">
            {loader ? (
              <div className="flex flex-col items-center justify-center space-y-4">
                ...
                <p className="text-gray-600">We're connecting your Facebook account...</p>
              ...
              <div className="flex flex-col items-center justify-center space-y-6">
                ...
                <p className="text-gray-600">Your Facebook account is now connected to SocialSync.</p>
